...
$$  \sum x_i >> \sum y_i,   $$
__answer:__ the sum of x1 is much greater than the sum of yi

$$ X \in \mathbb{R}^+ $$
__answer:__ X is an elemnt of the set of positive real numbers

$$ Y \in \mathbb{I}^+$$
__answer:__ Y is an element of the set of of positive integers

$$ x \in \mathbb{R}^+ \therefore x \notin \mathbb{R}^- $$
__answer:__ x is an element of the set of positive real numbers, therefore x minus y is an element of the set of negative real numbers

$$ y > x \therefore x - y \in \mathbb{R}^-$$
__answer:__y is greater than x, therefore x minus y is an element of the negative real numbers 

$$ x \in \mathbb{I}^-  y \in \mathbb{I}^+ \therefore x + y  \in \mathbb{I} $$

__answer:__x is an element of the set of negative integers , y is an elemnt of the positive real numbers, therefore x + y is an element of the set of integers

$$ x \varpropto y \because x = c \cdot y  $$
__answer:__ x is proportional to y, because x is equal to c times y 

$$ x \in \mathbb{I} \ and  \ x \notin \mathbb{I}^- \Rightarrow x \in \mathbb{I}^+ $$ 
__answer:__ x is an element of the set of integers and x is not an elemnt of the set of negative integers, then x is an element of the set of positive integers 
